...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql = "UPDATE doctor SET date='$date', date1='$date1', date2='$date2', date3='$date3' WHERE id='$id'";
...
<div class="card">
    <img src="../doctor/upload/<?php echo $row['image']?>">
    <table style="margin-top: 10px; margin-left: 20px; margin-right: 30px;">
        ...
        <tr>
            ...
            <td> <form action="" method="post">
                    ...
                    <br><br><button type="submit" class="btn btn-primary">Schedule</button>
                </form></td>
